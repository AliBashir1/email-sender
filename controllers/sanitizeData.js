...
exports.cleanUp = function (req, res, next) {
  ...
  let isValidUrl = true
  if (req.url === "/register") {
    if (typeof req.body.firstName != "string" || typeof req.body.lastName != "string" || typeof req.body.email != "string" || typeof req.body.password != "string" || typeof req.body.confirmPassword != "string") {
  ...
  // look for /recover-password/reset/(any alpha numeric)
    ...
    if (typeof req.body.firstName != "string" || typeof req.body.lastName != "string" || typeof req.body.currentEmail != "string" || typeof req.body.newEmail != "string") {
      flashMessage(req, res, "errors", "Unexpected errors, please try again", `/profile/${req.params.email}`)
    }
    req.body = {
      firstName: sanitizeHTML(req.body.firstName.trim(), { allowedTags: [], allowedAttributes: {} }),
